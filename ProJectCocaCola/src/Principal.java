...
public class Principal extends JFrame implements ActionListener {
	...
	public Principal() {
		...
		labelNombre = new JLabel("Datos del Trabajador para el calculo de vacaciones");
		labelNombre.setBounds(45,140,900,25);
		labelNombre.setFont(new Font("Andale Mono", 0, 24));
		...
		labelfooter = new JLabel("©2017 The Coca-Cola Compay | Todos los derechos reservados");
		labelfooter.setBounds(135,445,500,30);
		labelfooter.setFont(new java.awt.Font("Andale Mono", 1, 12));
		labelfooter.setBackground(new java.awt.Color(255,255,255));
		add(labelfooter);
	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == miCalculo) {
			...
			if(nombreTrabajador.equals("") || AP.contentEquals("") ||  AM.contentEquals("") ||
					Departamento.equals("") || Antiguedad.contentEquals("")) {
				...
				if(Departamento.equals("Departamento de Gerenica")) {
					if (Antiguedad.equals(	"1 año de servicio")) {
						textarea1.setText(	"\n   El trabajador " + nombreTrabajador + " " + AP + " " + AM + 
											"\n   quien labora en " + Departamento + " con " + Antiguedad + 
		...
		if (e.getSource() == miElCreador) {
			JOptionPane.showMessageDialog(null, "Desarrollado por Mi Company \n" +
												"     www.MiCompany.com");
		}
	}
